...
public class Estudiante {
    ...
    public void agregar(){
        try{
            ...
            String query="INSERT INTO db_segundoparcial.estudiantes(carnet,nombres,apellidos,direccion,telefono,genero,email,fecha_nacimiento) VALUES(?,?,?,?,?,?,?,?);";
            cn=new Conexion();
            cn.abrir_conexion();
    ...
    public void modificar(){
        try{
            PreparedStatement parametro;
            String query="UPDATE db_segundoparcial.estudiantes set carnet=?,nombres=?,apellidos=?,direccion=?,telefono=?,genero=?,email=?,fecha_nacimiento=?"+"where id_estudiante=?";
            cn=new Conexion();
            cn.abrir_conexion();
            parametro=(PreparedStatement) cn.conexionBD.prepareStatement(query);
            parametro.setString(1,getCarnet());
            ...
            int executar = parametro.executeUpdate();
            cn.cerrar_conexion();
            JOptionPane.showMessageDialog(null,Integer.toString(executar)+" Registro Modificado","Modificar",JOptionPane.INFORMATION_MESSAGE);
    ...
    public void eliminar(){
        try{
            PreparedStatement parametro;
            String query="DELETE FROM db_segundoparcial.estudiantes where id_estudiante=?";
            cn=new Conexion();
            cn.abrir_conexion();
            parametro=(PreparedStatement) cn.conexionBD.prepareStatement(query);
